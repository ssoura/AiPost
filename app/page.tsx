...
import StarBackground from "@/components/shooting-stars/StarBackground";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b bg-transparent overflow-hidden pt-20">
        <Navbar />
        ...
        <main className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="relative h-screen overflow-x-hidden">
            <div className="absolute inset-0 -top-12 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[250px] w-[800px] mix-blend-color-dodge rounded-full blur-[62px] pointer-events-none bg-gradient-to-b from-[rgba(43,0,255,0.415)] to-[rgba(255,0,0,0.8)] -z-10">
              </div>
              <div className="fixed w-full h-[100vh] -z-1">
                <StarBackground />
                <ShootingStars />
            <div className="h-100 w-100 bg-red-500">hello</div>
            </div>
